...
public enum PrideProjectFieldEnum {
    ...
    PROJECT_SUBMISSION_DATE(PrideProjectField.PROJECT_SUBMISSION_DATE, true, false,ConstantsSolrTypes.DATE ),
    PROJECT_PUBLICATION_DATE(PrideProjectField.PROJECT_PUBLICATION_DATE, true, false,ConstantsSolrTypes.DATE ),
    PROJECT_UPDATED_DATE(PrideProjectField.PROJECT_UPDATED_DATE, true, false, ConstantsSolrTypes.DATE),
