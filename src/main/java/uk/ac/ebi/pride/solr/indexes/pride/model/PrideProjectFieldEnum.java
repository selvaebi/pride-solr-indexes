...
public enum PrideProjectFieldEnum {
    ...
    PROJECT_SUBMISSION_TYPE(PrideProjectField.PROJECT_SUBMISSION_TYPE, true, false, ConstantsSolrTypes.TEXT_GENERAL),
    PROJECT_SUBMISSION_DATE(PrideProjectField.PROJECT_SUBMISSION_DATE, true, false,ConstantsSolrTypes.TEXT_GENERAL ),
    PROJECT_PUBLICATION_DATE(PrideProjectField.PROJECT_PUBLICATION_DATE, true, false,ConstantsSolrTypes.TEXT_GENERAL ),
    PROJECT_UPDATED_DATE(PrideProjectField.PROJECT_UPDATED_DATE, true, false, ConstantsSolrTypes.TEXT_GENERAL),
    PROJECT_SUBMITTER(PrideProjectField.PROJECT_SUBMITTER, false, false, ConstantsSolrTypes.TEXT_GENERAL ),
    PROJECT_PI_NAMES(PrideProjectField.PROJECT_PI_NAMES, false, false, ConstantsSolrTypes.TEXT_GENERAL),
    ...
    PROJECT_REFERENCES(PrideProjectField.PROJECT_REFERENCES, false, true, ConstantsSolrTypes.TEXT_GENERAL ),
    PROTEIN_IDENTIFICATIONS(PrideProjectField.PROTEIN_IDENTIFICATIONS, true, true, ConstantsSolrTypes.TEXT_GENERAL ),
    PROTEIN_IDENTIFICATIONS_FACET(PrideProjectField.PROTEIN_IDENTIFICATIONS_FACET, true, true, ConstantsSolrTypes.STRING ),

    PEPTIDE_SEQUENCES(PrideProjectField.PEPTIDE_SEQUENCES, false, true, ConstantsSolrTypes.TEXT_GENERAL),
    PROJECT_IDENTIFIED_PTM_STRING(PrideProjectField.PROJECT_IDENTIFIED_PTM_STRING, false, true, ConstantsSolrTypes.TEXT_GENERAL),
